...
<form action="insertar.php" method="POST" enctype="multipart/form-data">
				<table class="table">
				<tr><th colspan="5" class="bg-primary text-center" >AGREGA NUEVAS PISTAS DE AUDIO [MUSICA]</th></tr>
				<tr class="bg-primary">
				<th>PORTADA</th>
				<th>NOMBRE</th>
				<th>AUDIO</th>
				...
				<td><input  name="submitmus" type="submit" class="btn btn-success" value="AGREGAR" > </td>
				</tr>
				...
				<tr class="bg-info">
						<td><div style="text-align:right;">
							<input  name="elimmus" type="submit" class="btn btn-default" value="ELIMINAR" onclick='return confirm("¿Seguro que deseas eliminar este registro? Se borraran TODOS los registros de esta categoria (portadas, audios, etc)")'  >
						</div>
...
<option hidden value="MUSICA">→→→CATEGORIAS←←←</option>
...
<?php } ?>
				...
				<form  action="programamus.php" method="POST"><td>
...
$fecha2=date("d-m-Y",strtotime($fecha1));
					echo "<tr>
							...
							<td>".$fecha2. "</td>
							<td><form action='eliminarmus.php?id=".$row['id']."' method='POST' enctype='multipart/form-data'>
							...
							<form action='modificarmus.php?id=".$row['id']."'method='POST' enctype='multipart/form-data'>
