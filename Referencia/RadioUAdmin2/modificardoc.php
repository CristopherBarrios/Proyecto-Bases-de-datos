...
$sql = "SELECT * FROM documentales WHERE id='$id'";
...
<option hidden value="DOCUMENTALES">→→→CATEGORIA←←←</option>
...
<?php } ?>
				...
				<td><input  name="modificardoc" type="submit" class="btn btn-success" value="MODIFICAR" > </td>
				</tr>
