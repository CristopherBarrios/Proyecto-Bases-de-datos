...
<form action="insertar.php" method="POST" enctype="multipart/form-data">
				<table class="table">
				<tr><th colspan="5" class="bg-primary text-center" >AGREGA NUEVAS PISTAS DE AUDIO [ENTREVISTAS]</th></tr>
				<tr class="bg-primary">
				<th>PORTADA</th>
				<th>NOMBRE</th>
				<th>AUDIO</th>
				...
				<td><input  name="submitentre" type="submit" class="btn btn-success" value="AGREGAR" > </td>
				</tr>
				...
				<tr class="bg-info">
						<td><div style="text-align:right;">
							<input  name="elimentre" type="submit" class="btn btn-default" value="ELIMINAR" onclick='return confirm("¿Seguro que deseas eliminar este registro? Se borraran TODOS los registros de esta entrevista (portadas, audios, etc)")'  >
						</div>
...
<option hidden value="ENTREVISTAS">→→→CATEGORIAS←←←</option>
...
<?php } ?>
				...
				<form  action="programaentre.php" method="POST"><td>
...
$fecha2=date("d-m-Y",strtotime($fecha1));
					echo "<tr>
							...
							<form action='modificarentre.php?id=".$row['id']."'method='POST' enctype='multipart/form-data'>
